  ...
  $$renderer.component(($$renderer2) => {
    ...
    head("12qhfyh", $$renderer2, ($$renderer3) => {
      $$renderer3.title(($$renderer4) => {
        $$renderer4.push(`<title>Joymify Universe — Investor Portal</title>`);
      });
      $$renderer3.push(`<link rel="icon"${attr("href", favicon)}/> <meta name="description" content="The Command Center for the Joymify Universe. Explore 6 interconnected business pillars powered by the Lyzda currency ecosystem."/> <meta name="viewport" content="width=device-width, initial-scale=1"/> <meta property="og:title" content="Joymify Universe — Investor Portal"/> <meta property="og:description" content="Command Center. 6 Pillars. One Ecosystem."/> <meta name="theme-color" content="#09090b"/>`);
    });
    children($$renderer2);
    $$renderer2.push(`<!---->`);
  });
